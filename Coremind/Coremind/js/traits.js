...
(function (CM) {
  ...
  const WILD_SPECIES = [
    ...
    { id: 'sporetick', name: 'Sporetick', tier: 'predator', diet: 'carnivore',
      traits: ['camouflage', 'bite', 'chem_sense'], color: '#6db86a', subterranean: 4 },
    { id: 'echomite', name: 'Echomite', tier: 'predator', diet: 'carnivore',
      traits: ['vibration_sense', 'bite', 'burrowing'], color: '#5aa8c4', subterranean: 5 },
    { id: 'rubbleback', name: 'Rubbleback', tier: 'predator', diet: 'carnivore',
      traits: ['armor', 'claws', 'vibration_sense'], color: '#c48464', subterranean: 6 },
    { id: 'cinderback', name: 'Cinderback', tier: 'predator', diet: 'carnivore',
      traits: ['armor', 'heat_resistance', 'claws'], color: '#e07a4a', subterranean: 7 },
    { id: 'shadewinder', name: 'Shadewinder', tier: 'predator', diet: 'carnivore',
      traits: ['venom', 'camouflage', 'chem_sense'], color: '#9a6ac4', subterranean: 8 },
    { id: 'gateleech', name: 'Gateleech', tier: 'predator', diet: 'carnivore',
      traits: ['venom', 'fast_movement', 'vibration_sense'], color: '#7a6cff', subterranean: 9 },
    { id: 'voidmaw', name: 'Voidmaw', tier: 'predator', diet: 'carnivore',
      traits: ['venom', 'chem_sense', 'fast_movement'], color: '#8a5ad1', subterranean: 10 }
  ];
  const WILD_BY_ID = {};
