    ...
    "deficiencies": [
        {
            ...
            "standard_clause": "SYN-25-08.2.2", "procedure_id": "P-25-08-2-2",
            "requirement_basis": "Gauges shall be replaced or recalibrated at intervals not exceeding five years.",
        ...
        },
        {
            ...
            "standard_clause": "SYN-25-11.3.2", "procedure_id": "P-25-11-3-2",
            "requirement_basis": "Where a main drain test produces a residual pressure that differs by more than 10 percent from the previous test on record, the cause shall be determined and corrected.",
        ...
        },
        {
            ...
            "standard_clause": "SYN-25-13.2.6", "procedure_id": "P-25-13-2-6",
            "requirement_basis": "Each control valve shall be provided with a permanently marked, weatherproof identification sign indicating the portion of the system it controls.",
        ...
        },
        {
            ...
            "standard_clause": "SYN-25-05.2.1", "procedure_id": "P-25-05-2-1",
            "requirement_basis": "Spare sprinklers shall be maintained on the premises in a cabinet, in a quantity appropriate to the number of installed sprinklers, together with a wrench of the type required for each sprinkler present.",
        ...
        },
        {
            ...
            "standard_clause": "SYN-72-14.3.2", "procedure_id": "P-72-14-3-2",
            "requirement_basis": "A trouble or supervisory condition present at the panel at the time of inspection shall be recorded, together with the cause where it can be determined.",
        ...
        },
        {
            ...
            "standard_clause": "SYN-72-14.4.5", "procedure_id": "P-72-14-4-5",
            "requirement_basis": "Batteries shall be marked with the date of installation and replaced within the interval recommended by the manufacturer.",
        ...
        },
        {
            ...
            "standard_clause": "SYN-25-14.1.3", "procedure_id": "P-25-14-1-3",
            "requirement_basis": "An obstructed fire department connection shall be recorded as a critical deficiency and corrected without delay.",
